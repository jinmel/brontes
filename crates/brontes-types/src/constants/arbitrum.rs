...
pub const KYBERSWAP_CONTRACT_ADDRESS: Address =
    Address::new(hex!("6131B5fae19EA4f9D964eAc0408E4408b66337b5"));
pub const FILTER_TRANSFER_ADDRESSES: [Address; 7] = [
